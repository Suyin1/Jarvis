...
public:
    ...
    QStyleOptionFocusRect& operator=(const QStyleOptionFocusRect &other) {
        if (this != &other) {
...
public:
    ...
    QStyleOptionFrame& operator=(const QStyleOptionFrame &other) {
        if (this != &other) {
            QStyleOption::operator=(other);
...
public:
    ...
    QStyleOptionTabWidgetFrame& operator=(const QStyleOptionTabWidgetFrame &other) {
        if (this != &other) {
            QStyleOption::operator=(other);
            lineWidth = other.lineWidth;
            midLineWidth = other.midLineWidth;
            shape = other.shape;
            tabBarSize = other.tabBarSize;
            rightCornerWidgetSize = other.rightCornerWidgetSize;
            leftCornerWidgetSize = other.leftCornerWidgetSize;
            tabBarRect = other.tabBarRect;
            selectedTabRect = other.selectedTabRect;
        }
        return *this;
    }
...
public:
    ...
    QStyleOptionTabBarBase& operator=(const QStyleOptionTabBarBase &other) {
        if (this != &other) {
            QStyleOption::operator=(other);
            shape = other.shape;
            tabBarRect = other.tabBarRect;
...
public:
    ...
    QStyleOptionHeader& operator=(const QStyleOptionHeader &other) {
        if (this != &other) {
            QStyleOption::operator=(other);
...
public:
    ...
    QStyleOptionButton& operator=(const QStyleOptionButton &other) {
        if (this != &other) {
            QStyleOption::operator=(other);
            features = other.features;
            text = other.text;
...
public:
    ...
    QStyleOptionTab& operator=(const QStyleOptionTab &other) {
        if (this != &other) {
            QStyleOption::operator=(other);
            shape = other.shape;
            text = other.text;
            ...
            position = other.position;
            selectedPosition = other.selectedPosition;
            cornerWidgets = other.cornerWidgets;
            iconSize = other.iconSize;
            documentMode = other.documentMode;
            leftButtonSize = other.leftButtonSize;
            rightButtonSize = other.rightButtonSize;
            features = other.features;
        }
        return *this;
    }
...
public:
    ...
    QStyleOptionToolBar& operator=(const QStyleOptionToolBar &other) {
        if (this != &other) {
            QStyleOption::operator=(other);
            positionOfLine = other.positionOfLine;
            positionWithinLine = other.positionWithinLine;
            toolBarArea = other.toolBarArea;
            features = other.features;
            lineWidth = other.lineWidth;
            midLineWidth = other.midLineWidth;
        }
...
public:
    ...
    QStyleOptionProgressBar& operator=(const QStyleOptionProgressBar &other) {
        if (this != &other) {
            QStyleOption::operator=(other);
            ...
            orientation = other.orientation;
            invertedAppearance = other.invertedAppearance;
            bottomToTop = other.bottomToTop;
        }
        return *this;
    }
...
public:
    ...
    QStyleOptionMenuItem& operator=(const QStyleOptionMenuItem &other) {
        if (this != &other) {
            QStyleOption::operator=(other);
            menuItemType = other.menuItemType;
            checkType = other.checkType;
            checked = other.checked;
            menuHasCheckableItems = other.menuHasCheckableItems;
...
public:
    ...
    QStyleOptionDockWidget& operator=(const QStyleOptionDockWidget &other) {
        if (this != &other) {
            QStyleOption::operator=(other);
            title = other.title;
            ...
            verticalTitleBar = other.verticalTitleBar;
        }
        return *this;
    }
...
public:
    ...
    QStyleOptionViewItem& operator=(const QStyleOptionViewItem &other) {
        if (this != &other) {
            QStyleOption::operator=(other);
            displayAlignment = other.displayAlignment;
            decorationAlignment = other.decorationAlignment;
            textElideMode = other.textElideMode;
            decorationPosition = other.decorationPosition;
            decorationSize = other.decorationSize;
            font = other.font;
            showDecorationSelected = other.showDecorationSelected;
            features = other.features;
            locale = other.locale;
            widget = other.widget;
            index = other.index;
            ...
            icon = other.icon;
            text = other.text;
            viewItemPosition = other.viewItemPosition;
...
public:
    ...
    QStyleOptionToolBox& operator=(const QStyleOptionToolBox &other) {
        if (this != &other) {
            QStyleOption::operator=(other);
            text = other.text;
            icon = other.icon;
...
public:
    ...
    QStyleOptionRubberBand& operator=(const QStyleOptionRubberBand &other) {
        if (this != &other) {
            QStyleOption::operator=(other);
            shape = other.shape;
            opaque = other.opaque;
...
public:
    ...
    QStyleOptionComplex& operator=(const QStyleOptionComplex &other) {
        if (this != &other) {
            QStyleOption::operator=(other);
...
public:
    ...
    QStyleOptionSlider& operator=(const QStyleOptionSlider &other) {
        if (this != &other) {
            QStyleOptionComplex::operator=(other);
            orientation = other.orientation;
            minimum = other.minimum;
            maximum = other.maximum;
            ...
            notchTarget = other.notchTarget;
            dialWrapping = other.dialWrapping;
        }
        return *this;
    }
...
public:
    ...
    QStyleOptionSpinBox& operator=(const QStyleOptionSpinBox &other) {
        if (this != &other) {
            QStyleOptionComplex::operator=(other);
            buttonSymbols = other.buttonSymbols;
            stepEnabled = other.stepEnabled;
            frame = other.frame;
        }
        return *this;
    }
...
public:
    ...
    QStyleOptionToolButton& operator=(const QStyleOptionToolButton &other) {
        if (this != &other) {
            QStyleOptionComplex::operator=(other);
            features = other.features;
            icon = other.icon;
...
public:
    ...
    QStyleOptionComboBox& operator=(const QStyleOptionComboBox &other) {
        if (this != &other) {
            QStyleOptionComplex::operator=(other);
...
public:
    ...
    QStyleOptionTitleBar& operator=(const QStyleOptionTitleBar &other) {
        if (this != &other) {
            QStyleOptionComplex::operator=(other);
            text = other.text;
            icon = other.icon;
            titleBarState = other.titleBarState;
            titleBarFlags = other.titleBarFlags;
        }
        return *this;
    }
...
public:
    ...
    QStyleOptionGroupBox& operator=(const QStyleOptionGroupBox &other) {
        if (this != &other) {
            QStyleOptionComplex::operator=(other);
            features = other.features;
            text = other.text;
...
public:
    ...
    QStyleOptionSizeGrip& operator=(const QStyleOptionSizeGrip &other) {
        if (this != &other) {
            QStyleOptionComplex::operator=(other);
            corner = other.corner;
        }
...
public:
    ...
    QStyleOptionGraphicsItem& operator=(const QStyleOptionGraphicsItem &other) {
        if (this != &other) {
            QStyleOption::operator=(other);
            exposedRect = other.exposedRect;
            matrix = other.matrix;
