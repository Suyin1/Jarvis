...
#if defined(OS_OHOS)
  decltype(&cef_get_device_info) cef_get_device_info;
#endif
...
#if defined(OS_OHOS)
  INIT_ENTRY(cef_get_device_info);
#endif
  return 1;
}
...
#if defined(OS_OHOS)
NO_SANITIZE("cfi-icall")
cef_value_t* cef_get_device_info() {
  return g_libcef_pointers.cef_get_device_info();
}
#endif
