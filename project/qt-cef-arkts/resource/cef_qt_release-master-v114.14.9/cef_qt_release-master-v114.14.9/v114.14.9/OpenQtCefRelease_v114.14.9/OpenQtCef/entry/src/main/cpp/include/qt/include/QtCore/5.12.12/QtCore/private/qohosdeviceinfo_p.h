...
Q_CORE_EXPORT void init(QMap<Type, QVariant> devinfo);
Q_CORE_EXPORT QVariant getProperty(Type prop);

Q_CORE_EXPORT SupportedDeviceType getSupportedDeviceType();
Q_CORE_EXPORT bool isTablet();
