...
public:
    ...
    inline QVertexIndexVector(const QVector<quint32> &data)
        : t{UnsignedInt}, indices32{data}
    {}

    inline QVertexIndexVector(const QVector<quint16> &data)
        : t{UnsignedShort}, indices16{data}
    {}

    inline QVertexIndexVector(const QVertexIndexVector &other)
        : t{other.t}
...
{
    // inline QTriangleSet() { }
    inline QTriangleSet(const QVector<qreal> &v, const QVertexIndexVector &i) : vertices(v), indices(i) { }
...
{
    // inline QPolylineSet() { }
    inline QPolylineSet(const QVector<qreal> &v, const QVertexIndexVector &i) : vertices(v), indices(i) { }
